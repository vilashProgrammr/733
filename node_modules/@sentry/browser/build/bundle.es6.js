var Sentry = (function (exports) {
  ...
  ***************************************************************************** */
  ...
  const TRACEPARENT_REGEXP = /([0-9a-f]{2})-([0-9a-f]{32})-([0-9a-f]{16})-([0-9a-f]{2})/;
  /**
   * Span containg all data about a span
   */
  class Span {
      constructor(_traceId = uuid4(), _spanId = uuid4().substring(16), _recorded = false, _parent) {
   ...
   * @hidden
   */
  function breadcrumbEventHandler(eventName, debounce = false) {
      return (event) => {
