  ...
  <file original="ng.template" id="ngi18n">
    <unit id="2047558209369508311">
      <segment state="final">
        ...
        <target>My first i18n application</target>
      </segment>
    </unit>
    <unit id="4371668001355139802">
      <segment state="final">
        <source>Anwendung läuft!</source>
        <target>app workst!</target>
      </segment>
    </unit>
    <unit id="7499557905529977371">
      ...
      <segment state="final">
        ...
        <target>This app is for demonstration purposes only.</target>
      </segment>
    </unit>
    ...
    <unit id="9030312858648510700">
      ...
      <segment state="final">
        ...
        <target>Entry <ph id="0" equiv="INTERPOLATION" disp="{{number()}}"/> of total <ph id="1" equiv="INTERPOLATION_1" disp="{{total()}}"/> added.</target>
      </segment>
    </unit>
  ...
  enthält einen Zeilenumbruch.</source>
    ...
    <unit id="8998006760999956868">
      ...
      <segment state="final">
        ...
        <target>This text contains <pc id="0" equivStart="START_BOLD_TEXT" equivEnd="CLOSE_BOLD_TEXT" type="fmt" dispStart="&lt;b&gt;" dispEnd="&lt;/b&gt;">embedded html</pc></target>
      </segment>
    </unit>
    <unit id="5917488050182782344">
      <segment state="final">
        <source>Eine Nachricht per ngx-translate</source>
        <target>A message via ngx-translate</target>
      </segment>
    </unit>
    <unit id="6797180050921917715">
      ...
      <segment state="final">
        ...
        <target>Sample App Title</target>
      </segment>
    </unit>
    <unit id="8247252724313224625">
      ...
      <segment state="final">
        ...
        <target><ph id="0" equiv="INTERPOLATION" disp="{{priority}}"/>: A message from a service</target>
      </segment>
    </unit>
    ...
    <unit id="7644074577681906834">
      ...
      <segment state="final">
        ...
        <target><ph id="0" equiv="INTERPOLATION" disp="{{priority}}"/>: A message with a placeholder</target>
      </segment>
    </unit>
    <unit id="9223042936546558865">
      ...
      <segment state="final">
        ...
        <target><ph id="0" equiv="INTERPOLATION" disp="{{priority}}"/>: A message with 2 placeholders: <ph id="1" equiv="INTERPOLATION_1" disp="{{placeholder2}}"/></target>
      </segment>
    </unit>
    <unit id="7049669989298349710">
      ...
      <segment state="final">
        ...
        <target><ph id="0" equiv="INTERPOLATION" disp="{{priority}}"/>: A message with 2 placeholders: <ph id="1" equiv="INTERPOLATION" disp="{{priority}}"/> <ph id="2" equiv="INTERPOLATION_1" disp="{{placeholder2}}"/></target>
      </segment>
    </unit>
    <unit id="6651165993266138235">
      ...
      <segment state="final">
        ...
        <target>This message is <pc id="0" equivStart="START_BOLD_TEXT" equivEnd="CLOSE_BOLD_TEXT" type="fmt" dispStart="&lt;b&gt;" dispEnd="&lt;/b&gt;">IMPORTANT</pc></target>
      </segment>
    </unit>
    <unit id="7609655310648429098">
      ...
      <segment state="final">
        ...
        <target>This message is <pc id="0" equivStart="START_BOLD_TEXT" equivEnd="CLOSE_BOLD_TEXT" type="fmt" dispStart="&lt;b&gt;" dispEnd="&lt;/b&gt;"><pc id="1" equivStart="START_TAG_STRONG" equivEnd="CLOSE_TAG_STRONG" type="other" dispStart="&lt;strong&gt;" dispEnd="&lt;/strong&gt;">VERY IMPORTANT</pc></pc></target>
      </segment>
    </unit>
    <unit id="7610784844464920497">
      ...
      <segment state="final">
        ...
        <target>This message is <pc id="0" equivStart="START_TAG_STRANGE" equivEnd="CLOSE_TAG_STRANGE" type="other" dispStart="&lt;strange&gt;" dispEnd="&lt;/strange&gt;"><ph id="1" equiv="INTERPOLATION" disp="{{strangeness}}"/></pc></target>
      </segment>
    </unit>
    <unit id="explicitlysetids.test1">
      <segment state="final">
        <source>Explizit gesetzte ID</source>
        <target>Explicitly set ID</target>
      </segment>
    </unit>
  </file>
</xliff>
